    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <main>
                    <h4 class="top">All {{ $role_name }}s </h4>
                    <div class="main">
                        <p id="greater">Home <a class="greater" href="#"><i class="fas fa-greater-than"></i></a>All
                            {{ $role_name }}s </p>
                        <div>
                                ...
                                @else
                                    @foreach ($roles as $role)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="pin"
                                                    href="{{ route('AdminRolesCounter', ['role' => $role->name]) }}"><i
